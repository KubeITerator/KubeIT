...
func (db *Database) AddWorkflow(wf *test.Workflow) (id primitive.ObjectID, err error) {
...
func (db *Database) GetWorkflow(wfid primitive.ObjectID) (w *test.Task, err error) {
	wf := &test.Task{}
