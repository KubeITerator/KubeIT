...
type GroupAdminServiceClient interface {
	...
	DeleteGroup(ctx context.Context, in *GroupRequest, opts ...grpc.CallOption) (*StatusReport, error)
}
...
func (c *groupAdminServiceClient) CreateGroup(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Group, error) {
	out := new(Group)
...
func (c *groupAdminServiceClient) DeleteGroup(ctx context.Context, in *GroupRequest, opts ...grpc.CallOption) (*StatusReport, error) {
...
type GroupAdminServiceServer interface {
	...
	DeleteGroup(context.Context, *GroupRequest) (*StatusReport, error)
...
func (UnimplementedGroupAdminServiceServer) CreateGroup(context.Context, *Empty) (*Group, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateGroup not implemented")
}
func (UnimplementedGroupAdminServiceServer) DeleteGroup(context.Context, *GroupRequest) (*StatusReport, error) {
...
func _GroupAdminService_CreateGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GroupAdminServiceServer).CreateGroup(ctx, req.(*Empty))
	}
