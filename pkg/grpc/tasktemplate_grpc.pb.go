...
type TaskManagementServiceClient interface {
	CreateTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*StatusReport, error)
	GetTask(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*StatusReport, error)
	DeleteGroup(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*StatusReport, error)
}
...
func (c *taskManagementServiceClient) CreateTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*StatusReport, error) {
	out := new(StatusReport)
	err := c.cc.Invoke(ctx, "/kubeit.v1beta1.TaskManagementService/CreateTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskManagementServiceClient) GetTask(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*StatusReport, error) {
	out := new(StatusReport)
	err := c.cc.Invoke(ctx, "/kubeit.v1beta1.TaskManagementService/GetTask", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskManagementServiceClient) DeleteGroup(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*StatusReport, error) {
	out := new(StatusReport)
	err := c.cc.Invoke(ctx, "/kubeit.v1beta1.TaskManagementService/DeleteGroup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedTaskManagementServiceServer
// for forward compatibility
type TaskManagementServiceServer interface {
	CreateTask(context.Context, *Task) (*StatusReport, error)
	GetTask(context.Context, *IDRequest) (*StatusReport, error)
	DeleteGroup(context.Context, *IDRequest) (*StatusReport, error)
}

// UnimplementedTaskManagementServiceServer should be embedded to have forward compatible implementations.
type UnimplementedTaskManagementServiceServer struct {
}

func (UnimplementedTaskManagementServiceServer) CreateTask(context.Context, *Task) (*StatusReport, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateTask not implemented")
}
func (UnimplementedTaskManagementServiceServer) GetTask(context.Context, *IDRequest) (*StatusReport, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTask not implemented")
}
func (UnimplementedTaskManagementServiceServer) DeleteGroup(context.Context, *IDRequest) (*StatusReport, error) {
...
func _TaskManagementService_CreateTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubeit.v1beta1.TaskManagementService/CreateTask",
	}
...
func _TaskManagementService_GetTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubeit.v1beta1.TaskManagementService/GetTask",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskManagementServiceServer).GetTask(ctx, req.(*IDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TaskManagementService_DeleteGroup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubeit.v1beta1.TaskManagementService/DeleteGroup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskManagementServiceServer).DeleteGroup(ctx, req.(*IDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskManagementService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kubeit.v1beta1.TaskManagementService",
	...
	Metadata: "grpc/tasktemplate.proto",
}
