...
import (
	...
	"github.com/KubeITerator/KubeIT/API/v1alpha2/common"
...
func request_GroupAdminService_CreateGroup_0(ctx context.Context, marshaler runtime.Marshaler, client GroupAdminServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_GroupAdminService_CreateGroup_0(ctx context.Context, marshaler runtime.Marshaler, server GroupAdminServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq common.Empty
	var metadata runtime.ServerMetadata
...
func request_GroupAdminService_DeleteGroup_0(ctx context.Context, marshaler runtime.Marshaler, client GroupAdminServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_GroupAdminService_DeleteGroup_0(ctx context.Context, marshaler runtime.Marshaler, server GroupAdminServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GroupRequest
	var metadata runtime.ServerMetadata
...
// RegisterGroupAdminServiceHandlerServer registers the http handlers for service GroupAdminService to "mux".
...
func RegisterGroupAdminServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GroupAdminServiceServer) error {
...
// RegisterGroupAdminServiceHandler registers the http handlers for service GroupAdminService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterGroupAdminServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterGroupAdminServiceHandlerClient(ctx, mux, NewGroupAdminServiceClient(conn))
}

// RegisterGroupAdminServiceHandlerClient registers the http handlers for service GroupAdminService
...
func RegisterGroupAdminServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GroupAdminServiceClient) error {
